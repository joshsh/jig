...
Jig.CursorPipe = function(cursor) {
    return {
        next: function() {
            return cursor.next();
        },
...
Jig.LimitPipe = function(base, limit) {
    var count = 0;
    var closed = false;
...
/*
var s = "BEGIN ";
var c = store.getTriples(Part.resource('http://twitlogic.fortytwo.net/person/twitter/23024305'), null, null, null);

var q = new Jig.CursorPipe(c);
var p = new Jig.LimitPipe(q, 2);
...
var r = Part.resource('http://twitlogic.fortytwo.net/person/twitter/23024305');

g.triples(r, null, null, null).limit(3).head().outEdges().label().distinct().print();
//g.triples(r, null, null, null).limit(3).head().outEdges().limit(20).print();
//g.triples(r, null, null, null).limit(3).print();
//g.triples(r, null, null, null).limit(3).count();
